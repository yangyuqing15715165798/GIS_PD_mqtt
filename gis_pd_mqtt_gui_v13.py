...
from PySide6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                              ...
                              QScrollArea, QFileDialog, QStyleFactory)
...
#clear_button, #reset_cycles_button {
    background-color: #e74c3c;
}

#clear_button:hover, #reset_cycles_button:hover {
    background-color: #c0392b;
}

#view_db_button, #save_csv_button {
    background-color: #9b59b6;
}

#view_db_button:hover, #save_csv_button:hover {
...
class HistoricalChartsDialog(QDialog):
    ...
    def __init__(self, data, parent=None):
        ...
        self.export_button.setObjectName("save_csv_button")  # 使用相同的样式
        ...
        layout.addWidget(canvas_panel, 1)  # 添加拉伸因子，使图表区域占据更多空间
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        chart_settings_layout.setContentsMargins(15, 20, 15, 15)
        chart_settings_layout.setSpacing(10)
        ...
        self.reset_cycles_button.setObjectName("reset_cycles_button")
        ...
        self.view_db_button.setObjectName("view_db_button")
        ...
        main_layout.addWidget(canvas_panel, 1)  # 添加拉伸因子，使图表区域占据更多空间
        ...
        self.data_count_label.setStyleSheet("color: #333333;")
